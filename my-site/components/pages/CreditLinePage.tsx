...
export default function CreditLinePage() {
  const t = useTranslations("CreditLinePage");
        ...
        <div className="max-w-[120rem] mx-auto px-4 sm:px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <p className="font-paragraph text-xs sm:text-sm md:text-base lg:text-lg leading-relaxed mb-4 sm:mb-6 text-secondary">
                {t("hero.subtitle")}
              </p>
              <p className="font-paragraph text-xs sm:text-sm md:text-base lg:text-lg mb-6 sm:mb-8 text-secondary">
                {t("hero.description")}
              </p>
              <motion.div
